# OLAP
This program allows you to create queries in Python to calculate the minimum, maximum, mean, sum, and count of numeric columns on a data set of 129,046 lines and perform group-by along with top-k for categorical columns.
